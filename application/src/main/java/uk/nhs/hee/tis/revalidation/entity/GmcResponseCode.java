...
public enum GmcResponseCode {
    ...
    MISSING_OR_INVALID_RO_GMC_REF_NUMBER("84", "Missing / Invalid Responsible Officer GMC reference number"),
    ...
    DOCTOR_NOT_ASSOCIATED_WITH_DESIGNATED_BODY("140", "Doctor not associated with your Designated Body");
