...
public class DoctorsForDBServiceIT extends BaseIT {
    ...
    public void shouldReturnDataSortBySubmissionDateInDescOrder() throws Exception {
        ...
        assertThat(traineeInfo.get(0).getUnderNotice(), is(un4.value()));
        assertThat(traineeInfo.get(0).getSanction(), is(sanction4));
        assertThat(traineeInfo.get(0).getDoctorStatus(), is(status4.value()));
        ...
        assertThat(traineeInfo.get(2).getUnderNotice(), is(un5.value()));
        assertThat(traineeInfo.get(2).getSanction(), is(sanction5));
        assertThat(traineeInfo.get(2).getDoctorStatus(), is(status5.value()));
        ...
        assertThat(traineeInfo.get(3).getUnderNotice(), is(un1.value()));
        assertThat(traineeInfo.get(3).getSanction(), is(sanction1));
        assertThat(traineeInfo.get(3).getDoctorStatus(), is(status1.value()));
        ...
        assertThat(traineeInfo.get(4).getUnderNotice(), is(un3.value()));
        assertThat(traineeInfo.get(4).getSanction(), is(sanction3));
        assertThat(traineeInfo.get(4).getDoctorStatus(), is(status3.value()));
    ...
    public void shouldReturnDataSortByFirstNameInAscOrder() throws Exception {
        ...
        assertThat(traineeInfo.get(1).getUnderNotice(), is(un3.value()));
        assertThat(traineeInfo.get(1).getSanction(), is(sanction3));
        assertThat(traineeInfo.get(1).getDoctorStatus(), is(status3.value()));
        ...
        assertThat(traineeInfo.get(2).getUnderNotice(), is(un1.value()));
        assertThat(traineeInfo.get(2).getSanction(), is(sanction1));
        assertThat(traineeInfo.get(2).getDoctorStatus(), is(status1.value()));
    ...
    public void shouldReturnDataSortByLastNameInDescOrder() throws Exception {
        ...
        assertThat(traineeInfo.get(1).getUnderNotice(), is(un1.value()));
        assertThat(traineeInfo.get(1).getSanction(), is(sanction1));
        assertThat(traineeInfo.get(1).getDoctorStatus(), is(status1.value()));
        ...
        assertThat(traineeInfo.get(2).getUnderNotice(), is(un2.value()));
        assertThat(traineeInfo.get(2).getSanction(), is(sanction2));
        assertThat(traineeInfo.get(2).getDoctorStatus(), is(status2.value()));
