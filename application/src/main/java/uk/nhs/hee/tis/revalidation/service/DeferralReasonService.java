...
public class DeferralReasonService {
  ...
  public void insertDeferralReason() {
    final var insufficientEvidence = buildDeferralReason("1",
        "Insufficient evidence for a positive recommendation", buildDeferralSubReason("1"));
    final var doctorSubjectToProcess = buildDeferralReason("2",
        "The doctor is subject to an ongoing process", buildDeferralSubReason("2"));
  ...
  private DeferralReason buildDeferralReason(final String code, final String reason,
